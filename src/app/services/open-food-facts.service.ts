...
export class OpenFoodFactsService {
   ...
   * @private
   */
  private loadCustomIngredients(): void{
   ...
   * @private
   */
  private loadDefaultIngredients(): void{
    fetch('../../assets/data/ingredients.json').then(res => res.json()).then(json => {
      this.histamineFood = json.ingredients;
    });
  }
}
